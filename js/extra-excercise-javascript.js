...
function getEmployeeCount() {
    return Object.keys(salesReport.employees).length + " count of employees";
}
...
console.log(getTotalNumberOfSales() + " total sales")
...
//     var totalSales = [];
//     salesReport.forEach(function(employees){
//         totalSales.push(employees.salesUnits);
//     })
